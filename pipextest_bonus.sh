...
./pipex ./tests/test1.txt "grep inet" "wc -l" ./output1.txt #> valgrind1.txt 2>&1
...
./pipex ./tests/test1 "grep as" "sort" "uniq" ./output2.txt #> valgrind2.txt 2>&1
...
./pipex ./tests/test1 "cat -e" "grep a" "tr a-z A-Z" ./output3.txt #> valgrind3.txt 2>&1
...
./pipex ./tests/test1 "echo \"Hello World\"" "wc -w" ./output4.txt #> valgrind4.txt 2>&1
...
./pipex ./tests/test1 "ls non_existent_file" "wc -l" ./output5.txt #> valgrind5.txt 2>&1
...
./pipex ./tests/test1.txt "grep inet" ./output6.txt #> valgrind6.txt 2>&1
<./tests/test1.txt grep inet > ./output6_sh.txt
